...
describe Api::Internal::InstallmentsController do
  ...
  describe "POST create" do
    ...
    let(:params) do
      {
        installment: {
          ...
          files: [{ external_id: SecureRandom.uuid, stream_only: false, subtitles: [], url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/some-url.txt" }],
    ...
    it "creates a product-type installment" do
      ...
      expect(installment.product_files.sole.url).to eq("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/some-url.txt")
  ...
  describe "PUT update" do
    ...
    it "marks the old file as deleted" do
      installment.product_files.create!(url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/old-url.txt")
      expect do
        put :update, params: params.merge(id: installment.external_id), as: :json
      end.to change { installment.reload.product_files.count }.from(1).to(2)
      expect(installment.product_files.alive.sole.url).to eq("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/some-url.txt")
    end
