  ...
  describe "GET index" do
    before do
      ...
      create(:product_file, link_id: @mobile_friendly_pdf_product.id,
                            url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/23b2d41ac63a40b5afa1a99bf38a0982/original/nyt.pdf")
      @mobile_friendly_movie_product = create(:product, user: @user)
      create(:product_file, link_id: @mobile_friendly_movie_product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
      @mobile_friendly_mp3_product = create(:product, user: @user)
      create(:product_file, link_id: @mobile_friendly_mp3_product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
      ...
      create(:product_file, link_id: @mobile_zip_file_product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test.zip")
    end
    ...
    describe "successful response format" do
      it "returns product and file data" do
        ...
        create(:product_file, link: product, description: "A song", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
    ...
    describe "show all products" do
      ...
      it "includes preorder products", :vcr do
        ...
        create(:product_file, link_id: product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/preorder.zip")
