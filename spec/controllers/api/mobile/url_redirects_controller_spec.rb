...
describe Api::Mobile::UrlRedirectsController do
  before do
    ...
    @product_file1 = create(:product_file, position: 0, link: @product, description: nil, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/kFDzu.png")
    @product_file3 = create(:product_file, position: 1, link: @product, description: "A magic song", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
    @product_file2 = create(:product_file, position: 2, link: @product, description: "A picture", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/amir.png")
  ...
  describe "GET url_redirect_attributes" do
    ...
    it "provides purchase link and file data if the url redirect is still valid" do
      ...
      url_redirect = create(:url_redirect, link: product)
      product.product_files << create(:product_file, position: 0, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil.png")
  ...
  describe "GET stream" do
    ...
    let!(:file_1) do
      create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", is_transcoded_for_hls: true)
    end
    ...
    let(:subtitle_url_bucket_url) { "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/" }
  ...
  describe "GET download" do
    before do
      @product.product_files = [create(
        :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4"
      ),
                                create(
                                  :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter2.mp4"
                                )]
      @url_redirect = create(:url_redirect, link: @product, purchase: nil)
    end
    ...
    it "never displays a confirmation page for download urls" do
      s3_url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4?AWSAccessKeyId=AKIAIKFZLOLAPOKIC6EA&"
      ...
      @url_redirect.increment!(:uses, 1)
      @request.remote_ip = "123.4.5.6"
      loc_url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4?AWSAccessKeyId=AKIAIKFZLOLAPOKIC6EA&"
