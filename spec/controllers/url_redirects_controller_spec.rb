...
describe UrlRedirectsController do
  ...
  describe "GET 'download_page'" do
    ...
    describe "installments" do
      before do
        ...
        @seller_installment.product_files.create!(url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
  ...
  describe "GET 'show'" do
    it "returns http success" do
      ...
      s3_path = @url.sub("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs", "")
    ...
    describe "streaming" do
      it "renders correctly for stream-only files" do
        travel_to(Time.current) do
          ...
          product_file = create(:product_file,
                                url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/test.mp4",
                                filegroup: "video",
                                stream_only: true,
                                width: 1920,
                                height: 1080,
      ...
      describe "hls" do
        before do
          ...
          @video_file_1 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", is_transcoded_for_hls: true, display_name: "Chapter 2", position: 2)
        ...
        context "when the product has rich content" do
          it "sets the correct source urls for all video files in the product and returns the index of the file that should be played on load" do
            pdf_file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/manual.pdf")
            video_file_2 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4", position: 2)
            subtitle_file_en = create(:subtitle_file, language: "English", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/english.srt", product_file: video_file_2)
            subtitle_file_es = create(:subtitle_file, language: "Spanish", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/spanish.srt", product_file: video_file_2)
            video_file_3 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter3.mp4", position: 1)
        ...
        it "sets the correct source urls for all video attachments of an installment and returns the index of the file that should be played on load" do
          pdf_file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/manual.pdf")
          video_file_1 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", is_transcoded_for_hls: true, display_name: "Chapter 2", position: 2)
          video_file_2 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4", position: 1)
          subtitle_file_en = create(:subtitle_file, language: "English", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/english.srt", product_file: video_file_2)
          subtitle_file_fr = create(:subtitle_file, language: "Français", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/french.srt", product_file: video_file_2)
          video_file_3 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter_2_no_spaces.mp4", display_name: "Chapter 2 No Spaces", position: 0)
          mp3_file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
      ...
      describe "GET hls_playlist" do
        before do
          @multifile_product = create(:product)
          @file_1 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", is_transcoded_for_hls: true)
        ...
        it "urls encode the playlist urls" do
          @file_1.update_column(:url, "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter 2 of 5 (1280*720).mp4")
        ...
        it "escapes RFC 3986 2.2 reserved characters in the file name" do
          @file_1.update_column(:url, "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/me+you.mp4")
    ...
    describe "GET smil" do
      let(:product_file) do
        create(
          :product_file,
          url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4",
    ...
    describe "multiple files" do
      before do
        @product = create(:product)
        ch1 = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4"
        ch2 = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter2.mp4"
      ...
      it "redirects to the correct url for downloading a specific file" do
        ...
        url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4?"
    ...
    describe "Product" do
      ...
      context "when user is signed in" do
        ...
        it "gets current product file if replaced" do
          @product.product_files.each(&:mark_deleted)
          create(:product_file, link: @product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/nyt.pdf", filetype: "pdf")
