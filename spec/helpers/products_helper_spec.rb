  ...
  describe "#cdn_url_for" do
    before :each do
      ...
      stub_const("CDN_URL_MAP",
                 "https://s3.ap-southeast-2.amazonaws.com/gumroad/" => "https://asset.host.example.com/res/gumroad/",
                 "https://s3.ap-southeast-2.amazonaws.com/gumroad-staging/" => "https://asset.host.example.com/res/gumroad-staging/",
                 "https://gumroad-specs.s3.ap-southeast-2.amazonaws.com/" => "https://asset.host.example.com/res/gumroad-specs/")
    end
    ...
    it "returns correct cloudfront url for gumroad-staging bucket" do
      expect(@product).to receive(:preview_url).and_return("https://s3.ap-southeast-2.amazonaws.com/gumroad-staging/#{@product.preview.file.key}")
    ...
    it "returns unchanged s3 url for other bucket" do
      url = "https://s3.ap-southeast-2.amazonaws.com/gumroad_other/#{@product.preview.file.key}"
