...
describe("Product panel on creator profile - Sort/Filter", type: :system, js: true) do
  before do
    ...
    @preview_image_url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/kFDzu.png"
  ...
  describe "Filetype filter" do
    before do
      ...
      # seed ZIP
      create(:product_file, link: @b, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/preorder.zip")
      @c.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/preorder.zip")

      # seed MP3
      @c.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3")
      @c.save!
