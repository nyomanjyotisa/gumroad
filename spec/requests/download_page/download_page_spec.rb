...
describe("Download Page", type: :system, js: true) do
  describe "open in app" do
    before do
      ...
      create(:product_file, link_id: @product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/nyt.pdf").analyze
      create(:product_file, link_id: @product.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/nyt.pdf").analyze
    end
  ...
  describe "installments" do
    before do
      ...
      @post.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
  ...
  it "plays videos in the order they are shown on the download page for an installment" do
    ...
    post.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", position: 1, created_at: 2.day.ago)
    post.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/1/original/chapter1.mp4", position: 0, created_at: 1.day.ago)
    post.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/4/original/chapter4.mp4", position: 3, created_at: 1.hour.ago)
    post.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/3/original/chapter3.mp4", position: 2, created_at: 12.hours.ago)
