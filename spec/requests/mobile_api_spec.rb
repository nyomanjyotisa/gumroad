...
describe "Mobile API Request Specs" do
  ...
  describe "product download urls" do
    before do
      base_url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/chapter1.mp4"
  ...
  describe "external link url" do
    ...
    it "does not add external_link_url for non external link files" do
      @product.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
  ...
  it "serves stream urls that are usable" do
    @product.product_files << create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", is_transcoded_for_hls: true)
