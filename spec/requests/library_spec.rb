  ...
  context "membership purchases" do
    let(:product) do
      create(:membership_product, block_access_after_membership_cancellation: true,
                                  product_files: [create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil.png"),
                                                  create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pen.png")])
    end
    let!(:purchase1) do
