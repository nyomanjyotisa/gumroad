...
describe "InstallmentJson"  do
  ...
  describe "#installment_mobile_json_data" do
    before do
      ...
      @product_file_2 = create(:product_file, installment: @installment, link: @installment.link, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
