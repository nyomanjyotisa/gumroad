...
describe SubtitleFile do
    ...
    describe "file types" do
      ...
      context "when uploading an invalid type" do
        ...
        context "and subtitle is an S3 URL" do
          before do
            @subtitle = build(:subtitle_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad/attachments/1234/abcdef/original/My Awesome Youtube video.mov")
          end
      ...
      context "when uploading a valid type" do
        ...
        context "and subtitle is an S3 URL" do
          before do
            @subtitle = build(:subtitle_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad/attachments/1234/abcdef/original/My Subtitle.sub")
          end
  ...
  describe "#has_alive_duplicate_files?" do
    let!(:file_1) { create(:subtitle_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/some-file.srt") }
    let!(:file_2) { create(:subtitle_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/some-file.srt") }
