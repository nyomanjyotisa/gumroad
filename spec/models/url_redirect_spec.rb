...
describe UrlRedirect do
  ...
  describe "product_files_hash" do
    ...
    let!(:stream_only_video) { create(:streamable_video, stream_only: true, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/episode2.mp4") }
    ...
    describe "imported_customer" do
      ...
      it "returns the right url when there is no provided url redirect for and installment" do
        ...
        @product.product_files << create(
          :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/manual.pdf"
        )
  ...
  describe "streaming" do
    before do
      @product = create(:product)
      @product.product_files << create(
        :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/episode1.mp4"
      )
      @product.product_files << create(
        :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/episode2.mp4"
      )
      @product.product_files << create(
        :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/manual.pdf"
      )
    ...
    it "creates the correct signed URL for a stamped pdf" do
      ...
      url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/43a5363194e74e9ee75b6203eaea6705/original/stamped_manual.pdf"
  ...
  describe "product_file_json_data_for_mobile" do
    context "when there is an associated purchase" do
      it "contains the purchase information if there is an associated purchase" do
        product = create(:product)
        product.product_files << create(
          :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/6996320f4de6424990904fcda5808cef/original/Don&amp;#39;t Stop.mp3"
        )
        product.product_files << create(
          :product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/a1a5b8c8c38749e2b3cb27099a817517/original/Alice&#39;s Adventures in Wonderland.pdf"
        )
        purchase = create(:purchase, link: product, purchaser: create(:user))
        url_redirect = create(:url_redirect, link: product, purchase:)
  ...
  describe "#video_files_playlist" do
    let(:product) { create(:product) }
    let(:file2) { create(:product_file, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4", position: 3) }
    let(:file4) { create(:product_file, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/4/original/chapter4.mp4", position: 0) }
    let(:file1) { create(:product_file, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/1/original/chapter1.mp4", position: 2) }
    let(:file3) { create(:product_file, link: product, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/3/original/chapter3.mp4", position: 1) }
  ...
  describe "#html5_video_url_and_guid_for_product_file" do
    before do
      ...
      @file_1 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
      @multifile_product.product_files << @file_1
      @file_2 = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/3/original/chapter3.mp4")
