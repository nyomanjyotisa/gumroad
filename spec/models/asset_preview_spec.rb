...
describe AssetPreview, :vcr do
  describe "Attachment" do
    it "scales down a big image and keeps original" do
      ...
      expect(asset_preview.file.url).to match("https://gumroad-specs.s3.ap-southeast-2.amazonaws.com/#{asset_preview.file.key}")
      expect(asset_preview.retina_variant.url).to match("https://gumroad-specs.s3.ap-southeast-2.amazonaws.com/#{asset_preview.retina_variant.key}")
    ...
    it "succeeds with video" do
      ...
      expect(asset_preview.url).to match("https://gumroad-specs.s3.ap-southeast-2.amazonaws.com/#{asset_preview.file.key}")
    end
  ...
  describe "#url=" do
    ...
    it "works as expected with a public URL" do
      expect do
        asset_preview.url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/amir.png"
    ...
    it "works as expected when a URL with square brackets is encoded and passed as an argument" do
      expect do
        asset_preview.url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test-small+with+%5Bsquare+brackets%5D.jpg"
        asset_preview.analyze_file
        asset_preview.save!
      end.to_not raise_error
