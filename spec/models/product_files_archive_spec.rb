...
describe ProductFilesArchive do
  ...
  describe "#files_digest" do
    context "when there is no rich content" do
      it "returns the correct digest" do
        ...
        file_3 = create(:product_file, link: product, description: "file without a folder", url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/manual.pdf", folder_id: nil)
  ...
  describe "#set_url_if_not_present" do
    it "sets the url if not present" do
      ...
      expect(product_files_archive.url).to start_with("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments_zipped/")
  ...
  describe "#construct_url" do
    it "uses the entity name for an entity archive" do
      ...
      expect(entity_archive.url).to start_with("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments_zipped/")
    ...
    it "uses the folder name for a folder archive" do
      ...
      expect(folder_archive.url).to start_with("https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments_zipped/")
