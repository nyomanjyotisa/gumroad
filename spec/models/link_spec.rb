...
describe Link, :vcr do
    ...
    describe "publish!" do
      ...
      context "video transcoding" do
        ...
        it "doesn't transcode video when the link is draft" do
          video_file = create(:product_file, link_id: @video_link.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
        ...
        it "transcodes video files on publishing the product only if `queue_for_transcoding?` is true for the product file" do
          video_file_1 = create(:product_file, link_id: @video_link.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter2.mp4")
          video_file_2 = create(:product_file, link_id: @video_link.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter3.mp4")
          video_file_3 = create(:product_file, link_id: @video_link.id, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/2/original/chapter4.mp4")
          video_file_3.delete!
        ...
        describe "published links" do
          before do
            ...
            create(:product_file, link: @video_link, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil.png")
            @video_link.publish!
          end
  ...
  context "when attributes have S3 URLs" do
    before do
      stub_const("CDN_URL_MAP", { "https://s3.ap-southeast-2.amazonaws.com/gumroad/" => "https://static-2.gumroad.com/res/gumroad/" })
        ...
        original_description = %{
          ...
          <div class="medium-insert-images medium-insert-active contains-image-2085007717">
            <figure contenteditable="false">
              <img src="https://s3.ap-southeast-2.amazonaws.com/gumroad/files/sample/sample/original/sample.jpg" alt="">
            </figure>
          </div>
        }
