...
describe TwitterCards, :vcr do
  describe "#twitter_product_card" do
    ...
    it "does not uri escape the preview image url" do
      link = create(:product)
      create(:asset_preview, link:, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/file with spaces.png")
      link.product_files << create(:product_file, link:, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil1.png")
      link.save!
      link.reload
    ...
    it "does not uri escape the preview image url but it should html-escape it if necessary" do
      link = create(:product)
      create(:asset_preview, link:, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/file_with_double_quotes\".png")
      link.product_files << create(:product_file, link:, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil1.png")
      link.save!
      link.reload
