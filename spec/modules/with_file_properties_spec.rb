...
describe WithFileProperties do
  ...
  { audio: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/magic.mp3",
             filename: "magic.mp3", filegroup: "audio", constraints: { size: 466_312, duration: 46, bitrate: 128 } },
    exe: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test.exe",
           filename: "test.exe", filegroup: "executable", constraints: { size: 118 } },
    archive: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test.zip",
               filename: "test.zip", filegroup: "archive", constraints: { size: 67_852 } },
    psd: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/index.psd",
           filename: "index.psd", filegroup: "image", constraints: { size: 132_284 } },
    text: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/blah.txt",
            filename: "blah.txt", filegroup: "document", constraints: { size: 52 } },
    video: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/small.m4v",
             filename: "small.m4v", filegroup: "video",
             constraints: { size: 208_857, width: 320, height: 240, duration: 13, framerate: 60, bitrate: 125_779 } },
    image: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/kFDzu.png",
             filename: "kFDzu.png", filegroup: "image", constraints: { size: 47_684, width: 1633, height: 512 } },
    pdf_document: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/billion-dollar-company-chapter-0.pdf",
    ...
    word_document_docx: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/sample_doc.docx",
                          filename: "sample_doc.docx", filegroup: "document",
                          constraints: { size: 156_126, pagelength: 4 } },
    word_document: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test_doc.doc",
                     filename: "test_doc.doc", filegroup: "document", constraints: { size: 28_672, pagelength: 2 },
                     stubbing_method: :stub_for_word_doc },
    epub: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/sample.epub",
            filename: "test.epub", filegroup: "document", constraints: { size: 881_436, pagelength: 13 } },
    powerpoint: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test.ppt",
                  filename: "test.ppt", filegroup: "document",
                  constraints: { size: 954_368, pagelength: 7 }, stubbing_method: :stub_for_ppt },
    powerpoint_pptx: { fake_uri: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/test.pptx",
  ...
  describe "videos" do
    before do
      @video_file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/specs/sample.mov")
  ...
  describe "epubs" do
    before do
      @epub_file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/sample.epub")
  ...
  describe "very large files" do
    before do
      ...
      @product_file.url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/some-video-file.mov"
  ...
  describe "long file names" do
    before do
      @product_file = create(:product_file)
      @product_file.url = "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/5635138219475/1dc6d2b8f68c4da9b944e8930602057c/original/SET GS สปาหน้าเด็ก หน้าใส ไร้สิว อ่อนเยาว์ สวย เด้ง.jpg"
  ...
  it "raises a descriptive exception if the S3 object doesn't exist" do
    file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachments/missing.txt")
  ...
  context "with a incorrect s3_key" do
    it "corrects it and succeeds in analyzing the file" do
      ...
      file = create(:product_file, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/#{s3_directory}/incorrect-file-name.pdf")
      file.analyze
      file.reload
