...
describe "Product::Searchable - Indexing scenarios" do
  ...
  describe "#as_indexed_json" do
    it "includes all properties" do
      ...
      @product.tag!("tag")
      @product.save_files!([{ external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/some-url.txt" }])
      @product.save_files!([
                             { external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil.png" },
                             { external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pic.jpg" },
                             { external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/other.jpg" },
                           ])
  ...
  describe "Indexing the changes through callbacks" do
    ...
    it "updates the index for the associated product on product file save" do
      ...
      file_params = [{ external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pencil.png" },
    ...
    it "sends updated filetypes when a file is added" do
      expect_product_update %w[filetypes]
      @product.save_files!([{ external_id: SecureRandom.uuid, url: "https://s3.ap-southeast-2.amazonaws.com/gumroad-specs/attachment/pic.jpg" }])
    end
