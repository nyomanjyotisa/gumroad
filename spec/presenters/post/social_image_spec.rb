...
describe Post::SocialImage do
  ...
  context "when image is an ActiveStorage upload" do
    it "sets the full social image URL" do
      ...
      <p>First paragraph</p>
      <figure>
        <img src="https://gumroad-dev-public-storage-jyo.s3.ap-southeast-2.amazonaws.com/blobKey">
        <p class="figcaption">Image description</p>
      </figure>
      <p>Second paragraph</p>
      HTML
      social_image = Post::SocialImage.for(content_with_one_image)
      expect(social_image.url).to eq("https://gumroad-dev-public-storage-jyo.s3.ap-southeast-2.amazonaws.com/blobKey")
    end
  end
